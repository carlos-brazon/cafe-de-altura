...
const paintBags = (bags) => {
    ...
    if (!bags.length) {
        ...
        data.forEach((e) => {
            ...
            iva.innerHTML=(((subtotalenNumero)*1.21)-subtotalenNumero).toFixed(2).replace('.', ',');
            ...
            inputRadio[1].addEventListener('click', (event) =>{
                ...
                iva.innerHTML= ((totalenNumero*1.21)-totalenNumero).toFixed(2).replace('.', ',');
            });
            ...
            <p class="p-small flex">${e.quantity}</p>
